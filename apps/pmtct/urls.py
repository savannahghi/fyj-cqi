...
from apps.pmtct.views import add_patient_details, show_patient_details, try_adding_details, add_client_characteristics, \
    show_client_characterisation, update_client_characteristics, add_client_characteristics_trial, \
